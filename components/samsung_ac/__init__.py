...
CONF_STARTUP_DELAY_MS = "startup_delay_ms"
CONF_REGISTER_RETRY_INTERVAL_MS = "register_retry_interval_ms"
    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_STARTUP_DELAY_MS, default=80000): cv.int_range(
                min=0, max=600000
            ),
            cv.Optional(CONF_REGISTER_RETRY_INTERVAL_MS, default=5000): cv.int_range(
                min=100, max=60000
            ),
...
async def to_code(config):
    ...
    config_actions = {
        ...
        CONF_STARTUP_DELAY_MS: var.set_startup_delay_ms,
        CONF_REGISTER_RETRY_INTERVAL_MS: var.set_register_retry_interval_ms,
